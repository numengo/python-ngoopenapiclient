...
<attribute NAME="keywords" VALUE="API, API client, REST, REST API, swagger, openAPI, jsonschema, schema, marshalling"/>
...
<node TEXT="API client for API serving a swagger/openAPI schema" POSITION="right" ID="ID_439081159" CREATED="1564513063544" MODIFIED="1564562361030">
<icon BUILTIN="idea"/>
<edge COLOR="#7c007c"/>
</node>
<node TEXT="authors" POSITION="right" ID="ID_1099217662" CREATED="1564512586456" MODIFIED="1564562190310" LINK="python-ngoopenapiclient/AUTHORS.rst">
<icon BUILTIN="group"/>
<edge COLOR="#0000ff"/>
<node TEXT="Cedric ROMAN" ID="ID_1625049955" CREATED="1564512868837" MODIFIED="1564513399553" LINK="mailto:roman@numengo.com"/>
</node>
<node TEXT="documentation" POSITION="right" ID="ID_10359407" CREATED="1564512049272" MODIFIED="1564562378591" LINK="python-ngoopenapiclient/README.rst">
<icon BUILTIN="help"/>
<edge COLOR="#7c7c00"/>
</node>
